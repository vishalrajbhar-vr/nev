...
const specs = [
  ...
  { icon: <ArrowRight size={22} />, title: "Vehicle Size", value: "42 inch Width" },
...
const testimonials = [
  {
    ...
    rating: 5,
    text: "The NEV L5 Butterfly 6 Plus 1 has completely changed my daily commute. It offers a smooth ride, impressive battery backup, and is very comfortable even on longer journeys. Highly recommended!",
    initials: "RK",
    color: "blue",
  },
  {
    ...
    location: "Meerut, UP",
    rating: 5,
    text: "I've been riding the NEV L5 Butterfly 6 Plus 1 for over six months now. The charging cost is minimal, the performance is excellent, and maintenance is almost effortless. It's a great investment.",
    initials: "AS",
    color: "green",
  },
  {
  ...
  },
  {
    ...
    location: "Hapur, UP",
    rating: 5,
    text: "I chose the NEV L5 Butterfly 6 Plus 1 because of its modern features and sleek design. The acceleration is smooth, the battery range is impressive, and it's ideal for city commuting. Excellent value for money.",
    initials: "VY",
    color: "green",
  },
];
...
const faqData = [
  {
    q: "What is the range of the NEV L5 Butterfly 6 Plus 1 on a full charge?",
    a: "The NEV L5 Butterfly 6 Plus 1 delivers a reliable range of 60-80 km on a single full charge, making it ideal for daily city commutes.",
  },
  {
  ...
  {
    q: "What is the warranty coverage for the L5 Butterfly 6 Plus 1?",
    a: "NEV L5 Butterfly 6 Plus 1 comes with a 1+1 year warranty on the electric drivetrain and battery, offering confidence in long-term reliability.",
  },
  {
    q: "Is the L5 Butterfly 6 Plus 1 suitable for two passengers?",
    a: "Yes, the NEV L5 Butterfly 6 Plus 1 is designed with comfortable seating for two passengers and offers a smooth ride for both the rider and pillion.",
  },
];
...
const L5Butterfly = () => {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    try {
      await submitForm("product", { ...formData, product: "L5 Butterfly" });
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%]">
              ...
              <nav className="flex flex-wrap items-center gap-2 text-sm sm:text-base text-gray-500 mb-6">
                ...
                <span>Products</span>
                <FaChevronRight size={10} className="text-gray-300" />
                <span className="text-[#2346b7] font-semibold">L5 Butterfly 6 Plus 1</span>
              </nav>

              {/* Title */}
              <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-extrabold text-gray-900 tracking-tight">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2346b7] to-[#5BBF43]">
                  L5 Butterfly 6 Plus 1
                </span>
              </h1>

              <div className="w-24 h-1.5 bg-gradient-to-r from-[#2346b7] to-[#5BBF43] rounded-full mt-5 mb-4" />

              <p className="text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed">
                Power your journey with confidence. The all-new NEV L5 Butterfly 6 Plus 1
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-10 lg:gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <span className="inline-flex items-center px-4 py-1.5 rounded-full text-md sm:text-sm font-semibold text-gray-500 bg-green-400/10 border border-black/15 backdrop-blur-sm">
                L5 Segment Electric Vehicle
              </span>

              {/* title */}
              <h2 className="mt-5 text-2xl sm:text-4xl lg:text-[25px] font-bold leading-tight">
                <span className="text-black">L5 Butterfly 6 Plus 1</span>
                <br />
              ...
              <p className="mt-5 text-sm sm:text-base text-slate-500 leading-relaxed max-w-xl mx-auto lg:mx-0">
                Experience next-generation mobility with the NEV L5 Butterfly 6 Plus 1 — a
                stylish, high-performance electric vehical designed for everyday
              ...
              <div className="flex Dream big work hard tomorrow flex-wrap justify-center lg:justify-start gap-2.5 mt-6">
                {["Navigate Smarter", "Drive Greener", "Choose NEV L5 Butterfly"].map(
                  (tag) => (
                    <span
                      key={tag}
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                <div className="flex sm:flex-row items-center gap-3 border border-gray-400 rounded-xl py-4 px-5 mt-8 mx-auto lg:mx-0">
                  ...
                  <div className="w-full sm:w-auto text-center sm:text-left">
                    <h1 className="text-xl font-bold">110- 120</h1>
      ...
      <section className="py-8 sm:py-4 bg-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-gray-500 text-lg">
              What sets L5 Butterfly 6 Plus 1 apart from the competition.
            </p>
          </div>
      ...
      <section className="py-8 sm:py-15 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-gray-500 text-lg">
              Hear from the farmers and operators who trust L5 Butterfly 6 Plus 1 for
              their toughest jobs.
            </p>
          </div>
