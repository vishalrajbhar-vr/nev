        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-8 sm:py-10 lg:py-5">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%]">
              {/* Breadcrumb */}
              <nav className="flex flex-wrap items-center gap-2 text-sm sm:text-base text-gray-500 mb-4">
              ...
              {/* Title */}
              <h1 className="text-4xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-gray-900 leading-[1.1] tracking-tight">
