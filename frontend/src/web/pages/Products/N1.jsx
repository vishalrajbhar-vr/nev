...
const GALLERY_IMAGES = ["/images/Loadstar.png"];
...
const testimonials = [
  {
    ...
    rating: 5,
    text: "The NEV Loadstar has completely changed my daily commute. It offers a smooth ride, impressive battery backup, and is very comfortable even on longer journeys. Highly recommended!",
    initials: "RK",
    color: "blue",
  },
  {
    ...
    location: "Meerut, UP",
    rating: 5,
    text: "I've been riding the NEV Loadstar for over six months now. The charging cost is minimal, the performance is excellent, and maintenance is almost effortless. It's a great investment.",
    initials: "AS",
    color: "green",
  },
  {
  ...
  },
  {
    ...
    location: "Hapur, UP",
    rating: 5,
    text: "I chose the NEV Loadstar because of its modern features and sleek design. The acceleration is smooth, the battery range is impressive, and it's ideal for city commuting. Excellent value for money.",
    initials: "VY",
    color: "green",
  },
];
...
const faqData = [
  {
    q: "What is the range of the NEV Loadstar on a full charge?",
    a: "The NEV Loadstar delivers a reliable range of 60-80 km on a single full charge, making it ideal for daily city commutes.",
  },
  {
  ...
  {
    q: "What is the warranty coverage for the Loadstar?",
    a: "NEV Loadstar comes with a 1+1 year warranty on the electric drivetrain and battery, offering confidence in long-term reliability.",
  },
  {
    q: "Is the Loadstar suitable for two passengers?",
    a: "Yes, the NEV Loadstar is designed with comfortable seating for two passengers and offers a smooth ride for both the rider and pillion.",
  },
];
          ...
          >
            ...
            >
              <div className="relative w-[135%] h-[135%] flex items-center justify-center">
                <img
                  src="/images/Loadstar.png"
                  alt="NEV Loadstar Electric Scooter"
...
const Loadstar = () => {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    try {
      await submitForm("product", { ...formData, product: "Loadstar" });
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%]">
              ...
              <nav className="flex flex-wrap items-center gap-2 text-sm sm:text-base text-gray-500 mb-6">
                ...
                <FaChevronRight size={10} className="text-gray-300" />
                <span className="text-[#2346b7] font-semibold">Loadstar</span>
              </nav>
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed">
                ...
                efficient electric performance, smooth handling, and dependable
                reliability for every road.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-10 lg:gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h2 className="mt-5 text-2xl sm:text-4xl lg:text-[25px] font-bold leading-tight">
                <span className="text-black">Loadstar</span>
                <br />
              ...
              <p className="mt-5 text-sm sm:text-base text-slate-500 leading-relaxed max-w-xl mx-auto lg:mx-0">
                Experience next-generation mobility with the NEV Loadstar — a stylish,
                high-performance electric scooter designed for everyday
              ...
              <div className="flex Dream big work hard tomorrow flex-wrap justify-center lg:justify-start gap-2.5 mt-6">
                {["Navigate Smarter", "Drive Greener", "Choose Nev Loadstar"].map(
                  (tag) => (
                    <span
                      key={tag}
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                <div className="flex  sm:flex-row items-center md:gap-3 gap-7 border border-gray-400 rounded-xl py-4 px-5 mt-8 mx-auto lg:mx-0">
                ...
                <div className="flex sm:flex-row gap-7 md:gap-5  items-center  border border-gray-400 rounded-xl py-4 px-5 mt-8 mx-auto lg:mx-0">
                ...
                <div className="flex sm:flex-row md:gap-5 gap-7 items-center border border-gray-400 rounded-xl py-4 px-5 mt-8 mx-auto lg:mx-0">
