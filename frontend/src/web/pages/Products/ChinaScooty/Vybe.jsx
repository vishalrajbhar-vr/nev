...
/* ===================================================================
   SPECS DATA — pulled from the VYBE spec strip
=================================================================== */
const specGroups = [
  {
...
const testimonials = [
  {
    ...
    location: "Lucknow, UP",
    rating: 5,
    text: "The VYBE is light, peppy and perfect for my daily office commute. 120 km on a charge means I barely think about charging during the week.",
    initials: "RV",
    color: "blue",
  },
  {
...
const faqData = [
  {
    q: "What is the maximum range of the VYBE on a full charge?",
    a: "The VYBE delivers up to 120 km on a single full charge, making it one of the longest-range scooters in its segment for daily commuting.",
  },
  {
  ...
  {
    q: "What is the top speed of the VYBE?",
    a: "The VYBE has a top speed of 25 KPH, tuned for safe and efficient city and residential riding.",
  },
  {
    q: "What braking system does the VYBE use?",
    a: "The VYBE comes equipped with front and rear disc brakes for confident, reliable stopping power in all conditions.",
  },
  {
    q: "How much load can the VYBE carry?",
    a: "The VYBE is rated for a total load capacity of 150 kgs, comfortably supporting two riders along with everyday cargo.",
  },
];
          ...
          >
            <div className="absolute inset-0 flex items-center justify-center" style={{ transform: "translateZ(40px)" }}>
              <div className="relative w-[135%] h-[135%] flex items-center justify-center">
                <img
                  src="/images/china-vybe.png"
                  alt="VYBE Electric Scooter"
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div className="w-full lg:w-[55%]">
              <nav className="flex flex-wrap items-center gap-2 text-sm sm:text-base text-gray-500 mb-6">
                ...
                <FaChevronRight size={10} className="text-gray-300" />
                <span className="font-semibold" style={{ color: BLUE }}>Vybe</span>
              </nav>
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed">
                Ride further, stop safer. The all-new VYBE delivers a 120 km
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-gray-500 text-lg">
              Long range, strong stopping power, and a stable ride — the VYBE
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-10 lg:gap-14 items-center">
            <div className="text-center lg:text-left">
              ...
              <h2 className="mt-5 text-2xl sm:text-4xl lg:text-[25px] font-bold leading-tight">
                <span style={{ color: NAVY_DARK }}>VYBE</span>
                <br />
                <span
                  className="text-transparent bg-clip-text"
              ...
              <p className="mt-5 text-sm sm:text-base text-slate-500 leading-relaxed max-w-xl mx-auto lg:mx-0">
                Meet the VYBE — a bold, high-range electric scooter designed
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-2.5 mt-6">
                {["Ride Further", "Brake Smarter", "Choose Vybe"].map((tag) => (
                  <span
                    key={tag}
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-8">
            ...
            <p className="mt-4 text-gray-600 text-lg">
              Every number behind the VYBE — engineered for range, safety,
      ...
      <section className="py-8 sm:py-15 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <p className="mt-4 text-gray-500 text-lg">
              Real feedback from VYBE owners riding it every day across the
              city.
            </p>
          </div>
