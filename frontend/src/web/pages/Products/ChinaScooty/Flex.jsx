...
/* ===================================================================
   SPECS DATA — pulled from the FLEX spec strip
=================================================================== */
const specGroups = [
  {
...
const testimonials = [
  {
    ...
    location: "Lucknow, UP",
    rating: 5,
    text: "The FLEX is light, peppy and perfect for my daily office commute. 120 km on a charge means I barely think about charging during the week.",
    initials: "RV",
    color: "blue",
  },
  {
...
const faqData = [
  {
    q: "What is the maximum range of the FLEX on a full charge?",
    a: "The FLEX delivers up to 120 km on a single full charge, making it one of the longest-range scooters in its segment for daily commuting.",
  },
  {
  ...
  {
    q: "What is the top speed of the FLEX?",
    a: "The FLEX has a top speed of 25 KPH, tuned for safe and efficient city and residential riding.",
  },
  {
    q: "What braking system does the FLEX use?",
    a: "The FLEX comes equipped with front and rear disc brakes for confident, reliable stopping power in all conditions.",
  },
  {
    q: "How much load can the FLEX carry?",
    a: "The FLEX is rated for a total load capacity of 150 kgs, comfortably supporting two riders along with everyday cargo.",
  },
];
          ...
          >
            <div className="absolute inset-0 flex items-center justify-center" style={{ transform: "translateZ(40px)" }}>
              <div className="relative w-[135%] h-[135%] flex items-center justify-center">
                <img
                  src="/images/china-flex.png"
                  alt="FLEX Electric Scooter"
                  className="w-[120%] h-[120%] object-contain p-4 drop-shadow-2xl"
...
const Flex = () => {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    try {
      await submitForm("product", { ...formData, product: "Flex" });
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div className="w-full lg:w-[55%]">
              <nav className="flex flex-wrap items-center gap-2 text-sm sm:text-base text-gray-500 mb-6">
                ...
                <FaChevronRight size={10} className="text-gray-300" />
                <span className="font-semibold" style={{ color: BLUE }}>Flex</span>
              </nav>
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed">
                Ride further, stop safer. The all-new FLEX delivers a 120 km
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-gray-500 text-lg">
              Long range, strong stopping power, and a stable ride — the FLEX
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-10 lg:gap-14 items-center">
            <div className="text-center lg:text-left">
              ...
              <h2 className="mt-5 text-2xl sm:text-4xl lg:text-[25px] font-bold leading-tight">
                <span style={{ color: NAVY_DARK }}>FLEX</span>
                <br />
                <span
                  className="text-transparent bg-clip-text"
              ...
              <p className="mt-5 text-sm sm:text-base text-slate-500 leading-relaxed max-w-xl mx-auto lg:mx-0">
                Meet the FLEX — a bold, high-range electric scooter designed
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-2.5 mt-6">
                {["Ride Further", "Brake Smarter", "Choose Flex"].map((tag) => (
                  <span
                    key={tag}
                ...
                >
                  {GALLERY_IMAGES.map((src, i) => (
                    <img
                      ...
                      src={src}
                      alt={`Flex view ${i + 1}`}
                      className="w-[110%] h-[110%]  flex-shrink-0 object-contain"
                    />
                  ))}
                </div>
      ...
      <section className="py-8 sm:py-15 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <p className="mt-4 text-gray-500 text-lg">
              Real feedback from FLEX owners riding it every day across the
              city.
            </p>
          </div>
