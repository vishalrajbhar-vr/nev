...
const testimonials = [
  {
    ...
    rating: 5,
    text: "The L5 Front Facia gave our vehicle an instant premium look. It fits perfectly and feels very sturdy, even on rough roads.",
    initials: "RK",
    color: "blue",
  },
  {
    ...
    location: "Meerut, UP",
    rating: 5,
    text: "The finish quality is outstanding, and the aerodynamic profile has improved our vehicle's overall stance. Installation was quick and precise.",
    initials: "AS",
    color: "green",
  },
  {
    ...
    rating: 4,
    text: "The fitment is exact, the build is strong, and the styling transformed our fleet vehicles. It's a great upgrade for L5 owners.",
    initials: "SP",
    color: "blue",
  },
  {
    ...
    location: "Hapur, UP",
    rating: 5,
    text: "The premium front fascia is robust, modern, and adds confidence on the road. It gives our L5 series a sharper, more professional appearance.",
    initials: "VY",
    color: "green",
  },
];
...
const faqData = [
  {
    q: "What material is the L5 Front Facia made from?",
    a: "It is crafted from high-strength ABS composite with UV-resistant coating for long-lasting durability and a premium finish.",
  },
  {
    q: "Will it fit existing L5 chassis models?",
    a: "Yes, the L5 Front Facia is engineered for direct OEM fitment across compatible L5 series vehicles with no structural modifications needed.",
  },
  {
    q: "How long does installation take?",
    a: "A trained technician can complete the fitment in under an hour using standard tools, thanks to its bolt-on mounting design.",
  },
  {
    q: "What warranty does the Front Facia include?",
    a: "The product includes a 1-year warranty covering finish quality and fitment integrity, backed by our service network.",
  },
];
...
const FeatureCard = ({ icon, title, desc, color = "blue" }) => {
  ...
  return (
    <div
      className={`relative group bg-gradient-to-br ${c.bg} backdrop-blur-sm rounded-2xl p-3 sm:p-5 border ${c.border} hover:shadow-2xl transition-all duration-500 hover:-translate-y-1`}
    >
            ...
            >
              <div className="relative w-[120%] h-[120%]  flex items-center justify-center">
                <img
                  ...
                  alt="L5 Front Facia"
                  className="w-[120%] h-[120%] -mt-10 object-contain p-4 drop-shadow-2xl"
                  style={{
...
const L5FrontFacia = () => {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    try {
      await submitForm("product", { ...formData, product: "L5 Front Facia" });
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-10 lg:gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-2.5 mt-6">
                {["Sleek Design", "Quick Fit", "Built to Last"].map((tag) => (
                  <span
                    key={tag}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
                <div className="flex items-center justify-between md:gap-2 gap-7 border border-gray-400 rounded-xl py-3 px-3 mt-8 w-fit mx-auto lg:mx-0">
                ...
                >
                  {GALLERY_IMAGES.map((src, i) => (
                    <img
                      ...
                      className="w-[130%] h-[130%] -mt-15  flex-shrink-0 object-contain"
                    />
                  ))}
                </div>
          ...
          <table className="min-w-full border-collapse">
            ...
            <tbody>
              <tr className=" text-black text-md">
                <td className="px-4 py-4">Front Facia Kit</td>
                <td className="px-4 py-4">L5 Series OEM Fit</td>
                <td className="px-4 py-4">ABS Composite</td>
      ...
      <section className="py-8 sm:py-4 bg-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-gray-500 text-lg">
              What sets L5 Front Facia apart from the competition.
            </p>
          </div>
