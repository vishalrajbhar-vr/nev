...
=================================================================== */
const specs = [
  { icon: <Gauge size={22} />, title: "Power", value: "1.2 KW Peak Power" },
  { icon: <Wind size={22} />, title: "Top Speed", value: "33 KMPH" },
  {
    icon: <Wrench size={22} />,
    title: "Suspension Rear",
    value: "35 inch differential",
  },
  { icon: <Cog size={22} />, title: "Vehicle Size", value: "38 inch width" },
  ...
  { icon: <Users size={22} />, title: "Passenger Capacity", value: "4 + 1" },
];
...
const testimonials = [
  {
    ...
    rating: 5,
    text: "The L3 Butterfly MS is a reliable companion on long routes. Its efficient performance and smooth ride make daily passenger service much easier.",
    initials: "RK",
    color: "blue",
  },
  {
...
const faqData = [
  {
    q: "What is the engine power of the L3 Butterfly MS?",
    a: "The L3 Butterfly MS is powered by a 1.2 KW motor designed for efficient passenger operations with reliable low-end torque.",
  },
  {
  ...
  },
  {
    ...
    a: "The L3 Butterfly MS comes with a comprehensive 1-year warranty covering manufacturing defects and ensuring dependable support.",
  },
  {
          ...
          >
            ...
            >
              <div className="relative w-[130%] h-[130%] flex items-center justify-center">
                <img
                  src="/images/l3-butterfly-ms.png"
                  alt="L3 Butterfly MS"
                  className="h-[80%] w-[80%] object-contain p-4 drop-shadow-2xl"
                  style={{
...
const L3ButterflyMS = () => {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    try {
      await submitForm("product", { ...formData, product: "L3 Butterfly MS" });
  ...
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%]">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed">
                Power your journey with confidence. The L3 Butterfly MS delivers reliable passenger mobility, efficient operation, and strong durability for city and rural transport.
              </p>
      ...
      <section className="py-8 sm:py-15 bg-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <FeatureCard
              icon={<Zap size={28} />}
              title="1.2 KW Peak Power"
              desc="Efficient power delivery built for short-range passenger routes with stable pickup."
              color="blue"
            />
            <FeatureCard
              icon={<Thermometer size={28} />}
              title="Passenger Comfort"
              desc="Ergonomic 4+1 seating and supportive suspension for a smooth ride on busy city streets."
              color="green"
            />
            <FeatureCard
              icon={<Battery size={28} />}
              title="Battery Efficiency"
              desc="Advanced battery management delivers reliable 90-100 km range with low operating costs."
              color="amber"
            />
            <FeatureCard
              icon={<Wind size={28} />}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-10 lg:gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h2 className="mt-5 text-2xl sm:text-4xl lg:text-[25px] font-bold leading-tight">
                <span className="text-gray-500">L3 Butterfly MS</span>
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5BBF43] to-[#8be27a]">
                  Built for Comfort, Powered by Performance
                </span>
              </h2>

              {/* description */}
              <p className="mt-5 text-sm sm:text-base text-slate-500 leading-relaxed max-w-xl mx-auto lg:mx-0">
                Experience next-generation mobility with the NEV L3 Butterfly MS — a durable, efficient electric rickshaw designed for dependable 4+1 passenger transport. Its rugged build, low running cost, and comfortable ride make it perfect for city and village use.
              </p>

              {/* highlight tags */}
              <div className="flex flex-wrap justify-center lg:justify-start gap-2.5 mt-6">
                { ["Navigate Smarter", "Drive Greener", "Choose L3 Butterfly"].map(
                  (tag) => (
                    <span
                      key={tag}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
                <div className="flex items-center justify-between w-full border border-gray-400 rounded-xl py-3 px-6 mt-8 w-fit mx-auto lg:mx-0">
                  ...
                  <div>
                    <h1 className="text-xl font-bold">90- 100</h1>
                ...
                <div className="flex items-center justify-between gap-5 border border-gray-400 rounded-xl py-3 px-6 mt-8 w-fit mx-auto lg:mx-0">
                  ...
                  <div>
                    <h1 className="text-xl font-bold">4+1</h1>
            ...
            <div className="border border-gray-400 rounded-3xl px-2 py-3">
              ...
              <div className="relative rounded-3xl overflow-hidden bg-gradient-to-b from-white/[0.06] to-white/[0.02] border border-white/10 aspect-[4/3] sm:aspect-[16/11]">
                {/* sliding track */}
                <div
                  className="flex items-center justify-center py-2 h-[135%] -mt-20 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]"
                ...
                >
                  {GALLERY_IMAGES.map((src, i) => (
                    <img
                      key={src}
                      src={src}
                      alt={`L3 Butterfly MS view ${i + 1}`}
                      className="w-[75%] h-[75%] mt-10  flex-shrink-0 object-contain"
                    />
                  ))}
                </div>
      ...
      <section className="py-7 sm:py-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-9">
          ...
          <table className="min-w-full border-collapse">
            ...
            <tbody>
              <tr className=" text-black text-md">
                <td className="px-4 py-4">51.2 V 105 AH</td>
              ...
              <tr className=" text-black text-md">
                ...
                <td className="px-4 py-4">110 – 120</td>
                <td className="px-4 py-4">1+1 YEARS</td>
                <td className="px-4 py-4">1+1 YEARS</td>
                <td className="px-4 py-4">3 YEARS</td>
                <td className="px-4 py-4">__</td>
      ...
      {/* ============================================================
          SECTION 5: WHY CHOOSE L3 BUTTERFLY MS
      ============================================================ */}
      <section className="py-8 sm:py-4 bg-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-gray-500 text-lg">
              What sets the L3 Butterfly MS apart from the competition.
            </p>
          </div>
      ...
      <section className="py-8 sm:py-15 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-gray-500 text-lg">
              Hear from the drivers and operators who trust the L3 Butterfly MS for
