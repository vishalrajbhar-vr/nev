...
const testimonials = [
  {
    ...
    rating: 5,
    text: "The NEV ULight has completely changed my daily commute. It offers a smooth ride, impressive battery backup, and is very comfortable even on longer journeys. Highly recommended!",
    initials: "RK",
    color: "blue",
  },
  {
    ...
    location: "Meerut, UP",
    rating: 5,
    text: "I've been riding the NEV ULight for over six months now. The charging cost is minimal, the performance is excellent, and maintenance is almost effortless. It's a great investment.",
    initials: "AS",
    color: "green",
  },
  {
  ...
  },
  {
    ...
    location: "Hapur, UP",
    rating: 5,
    text: "I chose the NEV ULight because of its modern features and sleek design. The acceleration is smooth, the battery range is impressive, and it's ideal for city commuting. Excellent value for money.",
    initials: "VY",
    color: "green",
  },
];
...
const faqData = [
  {
    q: "What is the range of the NEV ULight on a full charge?",
    a: "The NEV ULight delivers a reliable range of 60-80 km on a single full charge, making it ideal for daily city commutes.",
  },
  {
  ...
  {
    q: "What is the warranty coverage for the ULight?",
    a: "NEV ULight comes with a 1+1 year warranty on the electric drivetrain and battery, offering confidence in long-term reliability.",
  },
  {
    q: "Is the ULight suitable for two passengers?",
    a: "Yes, the NEV ULight is designed with comfortable seating for two passengers and offers a smooth ride for both the rider and pillion.",
  },
];
            ...
            >
              <div className="relative w-[135%] h-[135%] flex items-center justify-center">
                <img
                  ...
                  alt="NEV ULight Electric Scooter"
...
const ULight = () => {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    try {
      await submitForm("product", { ...formData, product: "ULight" });
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%]">
              ...
              <nav className="flex flex-wrap items-center gap-2 text-sm sm:text-base text-gray-500 mb-6">
                ...
                <span>Products</span>
                <FaChevronRight size={10} className="text-gray-300" />
                <span className="text-[#2346b7] font-semibold">ULight</span>
              </nav>
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed">
                Power your journey with confidence. The all-new NEV ULight
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-10 lg:gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h2 className="mt-5 text-2xl sm:text-4xl lg:text-[25px] font-bold leading-tight">
                <span className="text-black">ULight</span>
                <br />
              ...
              <p className="mt-5 text-sm sm:text-base text-slate-500 leading-relaxed max-w-xl mx-auto lg:mx-0">
                Experience next-generation mobility with the NEV ULight — a
              ...
              <div className="flex Dream big work hard tomorrow flex-wrap justify-center lg:justify-start gap-2.5 mt-6">
                {["Navigate Smarter", "Drive Greener", "Choose Nev ULight"].map(
                  (tag) => (
                    <span
                      key={tag}
