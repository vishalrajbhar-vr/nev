...
const testimonials = [
  {
    ...
    rating: 5,
    text: "The L5 Ultra Loader is a reliable companion on long routes. Its strong power delivery and smooth ride make daily service much easier.",
    initials: "RK",
    color: "blue",
  },
  {
...
const faqData = [
  {
    q: "What is the engine power of L5 Ultra Loader?",
    a: "The L5 Ultra Loader is powered by a 6.5 KW engine designed for efficient operation with reliable low-end torque.",
  },
  {
  ...
  },
  {
    ...
    a: "L5 Ultra Loader comes with a comprehensive 1-year warranty covering manufacturing defects and ensuring dependable support.",
  },
  {
...
const L5UltraLoader = () => {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    try {
      await submitForm("product", { ...formData, product: "L5 Ultra Loader" });
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-8 sm:py-10 lg:py-5">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%]">
              ...
              <div className="w-24 h-1.5 bg-gradient-to-r from-[#2346b7] to-[#5BBF43] rounded-full mt-5 mb-3" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-10 lg:gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h2 className="mt-5 text-2xl sm:text-4xl lg:text-[25px] font-bold leading-tight">
                <span className="text-gray-500">L5 Ultra Loader</span>
                <br />
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
                ...
                <div className="flex items-center justify-between md:gap-5 gap-7 border border-gray-400 rounded-xl py-3 px-6 mt-8 w-fit mx-auto lg:mx-0">
                  ...
                  <div>
                    ...
                    <p className="text-md font-semibold">Capacity</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-400 rounded-3xl px-2 py-3">
              ...
              <div className="relative rounded-3xl overflow-hidden bg-gradient-to-b from-white/[0.06] to-white/[0.02] border border-white/10 aspect-[4/3] sm:aspect-[16/11]">
                {/* sliding track */}
                <div
                  className="flex items-center justify-center h-full -mt-7 py-2 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]"
                ...
                >
                  {GALLERY_IMAGES.map((src, i) => (
                    <img
                      key={src}
                      src={src}
                      alt={`L5 Ultra Loader view ${i + 1}`}
                      className="w-[130%] h-[130%] flex-shrink-0 object-contain"
                    />
                  ))}
                </div>
          ...
          <table className="min-w-full border-collapse">
            ...
            <tbody>
              <tr className=" text-black text-md">
                <td className="px-4 py-4">64V 132AH</td>
                <td className="px-4 py-4">100 – 110</td>
      ...
      <section className="py-8 sm:py-4 bg-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-gray-500 text-lg">
              What sets L5 Ultra Loader apart from the competition.
            </p>
          </div>
