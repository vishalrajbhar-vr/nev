...
const testimonials = [
  {
    ...
    rating: 5,
    text: "The L3 Butterfly SS is a reliable companion on long routes. Its efficient performance and smooth ride make daily passenger service much easier.",
    initials: "RK",
    color: "blue",
  },
  {
...
const faqData = [
  {
    q: "What is the engine power of the L3 Butterfly SS?",
    a: "The L3 Butterfly SS is powered by a 1.2 KW motor designed for efficient passenger operations with reliable low-end torque.",
  },
  {
  ...
  },
  {
    ...
    a: "The L3 Butterfly SS comes with a comprehensive 1-year warranty covering manufacturing defects and ensuring dependable support.",
  },
  {
...
const L3ButterflySS = () => {
  ...
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%]">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed">
                Power your journey with confidence. The L3 Butterfly SS delivers reliable passenger mobility, efficient operation, and strong durability for city and rural transport.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-10 lg:gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h2 className="mt-5 text-2xl sm:text-4xl lg:text-[25px] font-bold leading-tight">
                <span className="text-gray-500">L3 Butterfly SS</span>
                <br />
              ...
              <p className="mt-5 text-sm sm:text-base text-slate-500 leading-relaxed max-w-xl mx-auto lg:mx-0">
                Experience next-generation mobility with the NEV L3 Butterfly SS — a durable, efficient electric rickshaw designed for dependable 4+1 passenger transport. Its rugged build, low running cost, and comfortable ride make it perfect for city and village use.
              </p>
      ...
      {/* ============================================================
          SECTION 5: WHY CHOOSE L3 Butterfly SS
      ============================================================ */}
      <section className="py-8 sm:py-4 bg-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-gray-500 text-lg">
              What sets the L3 Butterfly SS apart from the competition.
            </p>
          </div>
      ...
      <section className="py-8 sm:py-15 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-gray-500 text-lg">
              Hear from the drivers and operators who trust the L3 Butterfly SS for
