...
const L5ECO = () => {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    try {
      await submitForm("product", { ...formData, product: "L5 ECO" });
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%]">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed">
                Power your journey with confidence. The L5 ECO 3 Plus 1 delivers smooth passenger mobility, reliable electric performance, and dependable comfort for city and rural routes.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <FeatureCard
              icon={<Zap size={28} />}
              title="4.5 KW Power"
              desc="Robust 4.5 KW motor tuned for smooth passenger transport and reliable daily uptime."
              color="blue"
            />
            <FeatureCard
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-10 lg:gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-2.5 mt-6">
                { ["Navigate Smarter", "Drive Greener", "Choose L5 ECO"].map(
                  (tag) => (
                    <span
                      key={tag}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
                <div className="flex items-center justify-between gap-3 border border-gray-400 rounded-xl py-3 px-6 mt-8 w-fit mx-auto lg:mx-0">
                  <CircleGauge className=" text-green-500" size={25} />
                  <div>
                    <h1 className="text-xl font-bold">80- 100</h1>
          ...
          <table className="min-w-full border-collapse">
            ...
            <tbody>
              <tr className=" text-black text-md">
                <td className="px-4 py-4">64V 105 AH</td>
                <td className="px-4 py-4">80 – 100</td>
              ...
              <tr className=" text-black text-md">
                <td className="px-4 py-4">64V 132 AH </td>
